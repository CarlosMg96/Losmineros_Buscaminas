...
function inicio() {
    ...
    buscaminas.numMinasTotales = document.getElementById("minas").value;
    if (buscaminas.numColumnas < 3 && buscaminas.numFilas < 3) {
        alert("Dibuja una matriz con valores mayores a 2");
    } else if (buscaminas.numMinasTotales < 1) {
        alert("Ingresa un minimo de 4 minas");
    } else{
        pintarTablero();
